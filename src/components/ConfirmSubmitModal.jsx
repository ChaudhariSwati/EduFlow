...
export default function ConfirmSubmitModal({ assignment, onConfirm, onClose }) {
  ...
  const boxStyle = {
    background:'rgba(34,31,53,0.97)', border:'1px solid rgba(108,99,255,0.2)',
    borderRadius:'20px', padding:'28px', width:'100%', maxWidth:'360px', animation:'fadeIn 0.3s ease'
  }
  const btnBase = {
    flex:1, padding:'11px', borderRadius:'12px', fontSize:'13px',
    fontWeight:600, cursor:'pointer', border:'none', fontFamily:'DM Sans,sans-serif'
  }
